...
URL Source: https://gemini3.devpost.com/rules
...
*   **Public Project Link:** A URL to your working product or interactive demo. Consider using AI Studio apps, which are the fastest way to build prototypes using the Gemini API.
    *   _This allows judges to experience your project firsthand, if applicable. It should be publicly accessible and not require a login or paywall._
...
*   Include a **demonstration video** of your Project. The video portion of the Project: 
    ...
    *   It should not be longer than 3 minutes. If it is longer than 3 minutes, _only the first 3 minutes may be evaluated_.
...
*   30-minute interview with the [AI Futures Fund](https://labs.google/aifuturesfund) team 1 All eligible submissions
...
*   30-minute interview with the [AI Futures Fund](https://labs.google/aifuturesfund) team 1 All eligible submissions
Honorable Mentions*   $2,000 USD

*   Social promotion of the winning project 10 All eligible submissions
